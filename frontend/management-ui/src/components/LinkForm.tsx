...
import { CloudUpload as UploadIcon, Close as CloseIcon, Code as CodeIcon } from '@mui/icons-material'
...
export function LinkForm({
  ...
  const {
    ...
    defaultValues: {
      ...
      pathType: initialData?.pathType || 'relative',
  ...
  const handleFormSubmit = async (data: LinkFormData) => {
    ...
    try {
      const linkData: Partial<NavigationLink> = {
        ...
        pathType: 'relative',  // All paths are relative
        ...
        parameters: detectedParameters.length > 0
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
      <DialogTitle>
        {mode === 'edit' ? 'Edit Navigation Link' : 'Add Navigation Link'}
      </DialogTitle>
      <DialogContent>
          ...
          <Controller
            ...
            render={({ field }) => (
              <TextField
                ...
                required
                fullWidth
                placeholder="/dashboard or https://example.com/page"
                error={!!errors.targetUrl}
                helperText={errors.targetUrl?.message || 'Path or full URL to navigate to'}
              />
            )}
          />
              ...
              <Stack spacing={2} className="mb-3">
                <Box className="grid grid-cols-2 gap-2">
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      setFormFieldInput({ ...formFieldInput, slot: e.target.value })
                    }
                    size="small"
