...
export const mockNavigationLinks: NavigationLink[] = [
  {
    ...
    multiModalEmbedding: {
      ...
      enhanced: {
        ...
        dataEntities: ["portfolios", "accounts", "holdings", "transactions"],
  ...
  results: [
    {
      ...
      primaryActions: ["View Balance", "Check Transactions", "Download Statement"],
      dataEntities: ["accounts", "transactions", "balances"],
    },
    {
      pageId: "2",
      ...
      primaryActions: ["View Transactions", "Filter by Date", "Export CSV", "Search"],
      dataEntities: ["transactions", "accounts", "dates"],
    },
    {
      pageId: "3",
